...
description: A skill for generating SEO,AEO,GEO-optimized blog pages and components in Next.js App Router. Use this when creating new routes that require high search visibility.
---

# Next.js SEO,AEO,GEO Master Skill

You are an expert in Next.js Performance and SEO,AEO,GEO. When this skill is activated, you must strictly follow these rules:
