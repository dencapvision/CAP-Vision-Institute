         ...
         <div className="bg-white py-16 border-t border-gray-100">
            <div className="max-w-7xl mx-auto px-4">
               ...
               <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <a href="/courses" className="group p-8 bg-gray-50 rounded-[2rem] border border-gray-100 hover:border-[#c5a059]/30 hover:shadow-lg transition-all text-center">
                  ...
                  <a href="/services" className="group p-8 bg-gray-50 rounded-[2rem] border border-gray-100 hover:border-[#c5a059]/30 hover:shadow-lg transition-all text-center">
                  ...
                  <a href="/about" className="group p-8 bg-gray-50 rounded-[2rem] border border-gray-100 hover:border-[#c5a059]/30 hover:shadow-lg transition-all text-center">
