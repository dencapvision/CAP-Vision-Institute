        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
          ...
          <div>
            ...
            <ul className="space-y-4 text-white/85 font-bold text-sm">
              <li><a href="/" className="hover:text-[#c5a059] transition-colors">หน้าหลัก</a></li>
              <li><a href="/courses" className="hover:text-[#c5a059] transition-colors">หลักสูตรพัฒนาผู้นำ</a></li>
              <li><a href="/events" className="hover:text-[#c5a059] transition-colors">กิจกรรม & เครือข่าย</a></li>
              <li><a href="/resources" className="hover:text-[#c5a059] transition-colors">คลังความรู้ & บทความ</a></li>
              <li><a href="/speakers" className="hover:text-[#c5a059] transition-colors">วิทยากร & Master Facilitator</a></li>
              <li><a href="/about" className="hover:text-[#c5a059] transition-colors">เกี่ยวกับ CAP Vision</a></li>
              <li><a href="/join-us" className="hover:text-[#c5a059] transition-colors">ร่วมงานกับเรา</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-white/85 font-bold text-sm">
              <li><a href="/services#in-house" className="hover:text-[#c5a059] transition-colors">In-house Training</a></li>
              <li><a href="/services#coaching" className="hover:text-[#c5a059] transition-colors">Executive Coaching</a></li>
              <li><a href="/services#consulting" className="hover:text-[#c5a059] transition-colors">OD Consulting</a></li>
              <li><a href="/services#facilitator" className="hover:text-[#c5a059] transition-colors">Facilitator Training</a></li>
              <li><a href="/subconscious-speaker" className="hover:text-[#c5a059] transition-colors">Subconscious Speaker</a></li>
              <li><a href="/web-app-pricing" className="hover:text-[#c5a059] transition-colors">Digital Learning Solutions</a></li>
              <li><a href="/contact" className="hover:text-[#c5a059] transition-colors">Customized Solutions</a></li>
              <li><a href="/services#leadership-roadmap" className="hover:text-[#c5a059] transition-colors">Leadership Roadmap</a></li>
            </ul>
          </div>
