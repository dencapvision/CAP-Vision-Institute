      ...
      <div className="max-w-7xl mx-auto px-4 mt-16">
        <div className="bg-[#0f3460] text-white p-12 rounded-[3rem] text-center shadow-2xl">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <a href="/courses" className="bg-[#c5a059] text-white px-10 py-4 rounded-2xl font-bold nav-font hover:bg-white hover:text-[#0f3460] transition-all">
              ดูหลักสูตรทั้งหมด
            </a>
            <a href="/contact" className="border-2 border-white/30 text-white px-10 py-4 rounded-2xl font-bold nav-font hover:bg-white/10 transition-all">
              ติดต่อเรา
            </a>
          </div>
        </div>
