...
const ReflectionPanel: React.FC<ReflectionPanelProps> = ({ articleTitle }) => {
  ...
  if (isSaved) {
    return (
      <div className="bg-[#f8fafc] border-2 border-green-100 rounded-[2.5rem] p-10 text-center animate-fade-in my-12 shadow-inner">
        <div className="w-16 h-16 bg-green-500 rounded-full flex items-center justify-center mx-auto mb-6 text-white shadow-lg shadow-green-100 animate-bounce">
        ...
        <button 
          ...
          className="mt-8 text-xs font-black text-gray-400 hover:text-blue-600 transition-colors uppercase tracking-widest nav-font cursor-pointer"
        >
          Do it again
        </button>
      </div>
  ...
  return (
    <div className="relative bg-white border-2 border-gray-100 rounded-[3rem] p-10 md:p-14 my-16 shadow-2xl shadow-blue-50/50 overflow-hidden group">
      {/* Background Accent */}
      <div className="absolute -top-20 -right-20 w-64 h-64 bg-blue-50/50 rounded-full blur-3xl group-hover:scale-110 transition-transform duration-700 pointer-events-none" />
      ...
      <div className="relative">
        ...
        <div className="bg-[#fcfdfe] border border-gray-100 rounded-[2rem] p-8 md:p-10 mb-8 min-h-[220px] transition-all duration-500">
          ...
          <textarea
            ...
            className="w-full bg-transparent border-none focus:ring-0 text-gray-600 placeholder:text-gray-300 min-h-[100px] text-lg font-medium leading-relaxed resize-none focus:outline-none"
            placeholder={currentStep.placeholder}
          />
        </div>

        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-[10px] font-medium text-gray-400 max-w-[240px] text-center sm:text-left">
          ...
          <button 
            ...
            className={`flex items-center gap-2 py-4 px-10 rounded-2xl font-black nav-font tracking-widest transition-all shadow-lg cursor-pointer ${
