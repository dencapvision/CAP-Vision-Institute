  ...
  return (
    <div className="w-full max-w-3xl mx-auto">
      <form onSubmit={handleSubmit} className="relative group">
        <div className={`absolute inset-0 bg-gradient-to-r from-blue-600/20 to-amber-500/20 blur-2xl rounded-[2.5rem] transition-opacity duration-500 pointer-events-none ${isFocused ? 'opacity-100' : 'opacity-0'}`} />
        ...
        <div className={`relative flex items-center bg-white rounded-[2rem] p-2 pr-4 shadow-xl border-2 transition-all duration-300 ${isFocused ? 'border-[#1D4ED8] ring-4 ring-blue-50' : 'border-gray-100 group-hover:border-blue-100'}`}>
          <div className="flex-grow relative overflow-hidden pl-6 flex items-center">
            ...
            <input
              ...
              className="w-full py-4 pl-10 pr-4 bg-transparent border-none focus:ring-0 text-lg font-bold text-[#0f3460] placeholder:text-gray-300 transition-all font-sans focus:outline-none"
          ...
          <button 
            type="submit"
            className="flex items-center gap-2 bg-[#1D4ED8] text-white px-8 py-3.5 rounded-2xl font-black nav-font tracking-widest hover:scale-105 transition-all shadow-lg shadow-blue-100 cursor-pointer"
          >
            ...
            <div className="flex flex-wrap gap-2">
              {[
                ...
                <button
                  ...
                  className={`flex items-center gap-2 px-4 py-2.5 rounded-xl text-xs font-black transition-all hover:scale-105 cursor-pointer ${topic.color}`}
                >
