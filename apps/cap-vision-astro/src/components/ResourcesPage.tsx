...
import { fetchPublishedArticles, type BlogArticleRow } from '../lib/services/blog-articles';
import { fetchPublishedVideos, fetchPublishedToolkits, type MicroVideo, type ToolkitDownload } from '../lib/services/resources-admin';
    ...
    <div className="bg-white min-h-screen">
      ...
      <section className="relative bg-[#0f3460] pt-32 pb-24 overflow-hidden">
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute top-0 right-0 w-2/3 h-2/3 bg-[#c5a059]/10 rounded-full blur-[120px] -translate-y-1/2 translate-x-1/4 pointer-events-none" />
        </div>
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10 text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-black nav-font leading-[1.1] tracking-tight mb-6 text-white">
            <span className="text-[#c5a059]">ศูนย์รวมความรู้</span><br />
            <span>ด้านการพัฒนาคนและองค์กร</span>
          </h1>
          ...
          <p className="text-white/80 text-lg md:text-xl font-light leading-relaxed mb-10 max-w-2xl mx-auto">
            ...
            <span className="text-white/85 font-semibold">บทความ · วิดีโอ · เครื่องมือฟรี</span> โดยทีม CAP Vision Institute
          </p>

          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="#featured"
              className="bg-[#c5a059] text-white px-8 py-4 rounded-2xl font-black text-base nav-font flex items-center justify-center gap-3 hover:bg-[#e0c58e] hover:text-[#0f3460] transition-all shadow-2xl cursor-pointer"
            >
              อ่านบทความแนะนำ <ArrowRight className="w-5 h-5" />
            </a>
            <a
              href="#teaching-docs"
              className="bg-white/5 border-2 border-white/20 text-white px-8 py-4 rounded-2xl font-black text-base nav-font flex items-center justify-center gap-3 hover:bg-white/10 transition-all cursor-pointer"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {featuredArticles.map((article, idx) => (
              <a
                ...
                className="group bg-white rounded-3xl border border-gray-100 overflow-hidden hover:shadow-2xl transition-all duration-300 flex flex-col cursor-pointer"
              >
                <div className="relative h-48 overflow-hidden">
                  ...
                  />
                  {idx === 0 && (
                    <div className="absolute top-4 left-4 bg-[#c5a059] text-white text-[9px] font-black uppercase tracking-widest px-3 py-1.5 rounded-full nav-font shadow-md">
                      Hot
                    </div>
                  )}
                </div>
      ...
      <section className="py-12 bg-[#0f3460]/5 border-y border-[#c5a059]/10">
        <div className="max-w-4xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <a
            href="/contact"
            className="bg-[#c5a059] text-white px-8 py-4 rounded-2xl font-black nav-font flex items-center gap-3 hover:bg-[#e0c58e] hover:text-[#0f3460] transition-all whitespace-nowrap shadow-lg cursor-pointer"
          >
        ...
        <div className="max-w-7xl mx-auto px-6">
            ...
            {CATEGORIES.map((cat, idx) => {
              ...
              return (
                <button
                  ...
                  className={`flex items-center gap-2 px-5 py-3 rounded-2xl font-black text-sm nav-font transition-all cursor-pointer ${
                    activeCategory === idx
          ...
          <div className="text-center mt-10">
            <button
              ...
              className="inline-flex items-center gap-2 text-[#0f3460] font-black text-sm nav-font border-2 border-[#0f3460]/20 px-6 py-3 rounded-2xl hover:border-[#c5a059] hover:text-[#c5a059] transition-all cursor-pointer"
            >
            ...
            <div className="flex items-center justify-between mb-12">
              <div>
                <div className="flex items-center gap-2 mb-3">
                  <span className="bg-[#c5a059]/10 text-[#c5a059] text-[9px] font-black uppercase tracking-widest px-3 py-1.5 rounded-full nav-font flex items-center gap-1.5 shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {aeoArticles.map((article) => (
                <a
                  ...
                  className="group bg-white rounded-3xl border border-gray-100 overflow-hidden hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 flex flex-col cursor-pointer"
                >
                  {article.thumbnail ? (
                    <div className="relative h-44 overflow-hidden">
                      <img
      ...
      <section className="py-16 bg-white border-y border-[#c5a059]/10">
        <div className="max-w-5xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="/courses"
              className="bg-[#0f3460] text-white px-8 py-4 rounded-2xl font-black nav-font flex items-center justify-center gap-3 hover:bg-[#1a4a7a] transition-all cursor-pointer"
            >
              ดูหลักสูตรทั้งหมด <GraduationCap className="w-5 h-5" />
            </a>
            <a
              href="/contact"
              className="border-2 border-[#c5a059] text-[#c5a059] px-8 py-4 rounded-2xl font-black nav-font flex items-center justify-center gap-3 hover:bg-[#c5a059] hover:text-white transition-all cursor-pointer"
            >
                ...
                >
                  ...
                  {dlUrl ? (
                    <a
                      ...
                      download
                      className="w-full bg-[#0f3460] text-white py-4 rounded-2xl font-black flex items-center justify-center gap-3 hover:bg-[#c5a059] transition-all nav-font text-sm cursor-pointer"
                    >
            ...
            {downloadSubmitted ? (
              ...
              <div className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
                ...
                <button
                  ...
                  className="bg-[#c5a059] text-white px-8 py-4 rounded-2xl font-black nav-font hover:bg-[#e0c58e] hover:text-[#0f3460] transition-all whitespace-nowrap cursor-pointer"
                >
                  รับฟรีเลย
                </button>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="flex items-center gap-3 mb-10">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 bg-[#0f3460]/5 border border-[#0f3460]/10 px-4 py-2 rounded-xl text-[#0f3460] font-black text-sm nav-font hover:bg-[#c5a059]/10 hover:border-[#c5a059]/30 transition-all cursor-pointer"
            >
      ...
      <section className="py-24 bg-[#0f3460] relative overflow-hidden">
        <div className="absolute top-0 right-0 w-96 h-96 bg-[#c5a059]/10 rounded-full blur-[120px] translate-x-1/2 -translate-y-1/2 pointer-events-none" />
        <div className="absolute bottom-0 left-0 w-72 h-72 bg-blue-500/5 rounded-full blur-[80px] pointer-events-none" />
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
            <a
              href="/contact"
              className="bg-[#c5a059] text-white px-10 py-5 rounded-2xl font-black text-lg nav-font flex items-center justify-center gap-3 hover:bg-[#e0c58e] hover:text-[#0f3460] transition-all shadow-2xl cursor-pointer"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="bg-white/5 border-2 border-white/20 text-white px-10 py-5 rounded-2xl font-black text-lg nav-font flex items-center justify-center gap-3 hover:bg-white/10 transition-all cursor-pointer"
            >
