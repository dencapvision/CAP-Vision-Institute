...
export const SpeakerDetail: React.FC<{ id?: string }> = ({ id: propId }) => {
  ...
  if (!speaker) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-white gap-4 px-4">
        ...
        <a href="/speakers" className="btn-premium bg-[#2563EB] text-white px-6 py-3 rounded-2xl text-xs font-bold">
          ดูวิทยากรทั้งหมด
        </a>
      </div>
    );
