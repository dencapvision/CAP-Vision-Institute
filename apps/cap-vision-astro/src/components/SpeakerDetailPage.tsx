...
import { DrSoBookingWizard } from './DrSo/BookingWizard';
import { BookingWizard } from './Speakers/BookingWizard';
    ...
    <div className="bg-gray-50 min-h-screen">
      <div className="bg-[#0f3460] pt-24 pb-40 text-white relative">
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          <a href="/speakers" className="inline-flex items-center gap-2 text-blue-200 hover:text-[#c5a059] transition-colors mb-10">
    ...
    <div className="bg-white min-h-screen font-sans">
      ...
      <section className="relative pt-32 pb-24 bg-[#0a1628] overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <a href="/speakers" className="inline-flex items-center gap-2 text-white/50 hover:text-[#c5a059] transition-colors mb-12 uppercase font-black text-sm">
  ...
  return (
    <div className="bg-[#050a14] min-h-screen text-white font-['Sarabun'] scroll-smooth">
      ...
      <section className="relative pt-32 pb-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <a href="/speakers" className="inline-flex items-center gap-2 text-white/50 hover:text-[#c5a059] transition-colors mb-12 uppercase font-black text-sm tracking-widest group">
