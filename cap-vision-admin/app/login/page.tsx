    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0a1628] via-[#0f2347] to-[#0a1628] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl">
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-[#c5a059] hover:bg-[#d4b060] disabled:opacity-50 text-white font-bold py-3 rounded-xl flex items-center justify-center gap-2 transition-all shadow-lg shadow-[#c5a059]/20"
            >
              {loading ? (
        ...
        <p className="text-center text-white/20 text-xs mt-6">
          CAP Vision Institute © 2025 — Admin System
        </p>
      </div>
    </div>
  )
