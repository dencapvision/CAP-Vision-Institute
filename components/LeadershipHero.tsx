          ...
          <div className="lg:col-span-7 xl:col-span-8">
            <div className="flex flex-col space-y-8">
              ...
              <div className="space-y-3">
                ...
                <h2 className="text-lg md:text-2xl font-black text-white nav-font uppercase tracking-wider">
                  Transformative Learning Programs
                </h2>
              </div>

              {/* Subtitle */}
              <p className="text-base md:text-xl text-white/90 leading-relaxed font-light max-w-2xl border-l-4 border-[#c5a059] pl-6 py-2">
