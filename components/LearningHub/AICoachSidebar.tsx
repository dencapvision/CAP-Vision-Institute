          ...
          if (part.startsWith('**') && part.endsWith('**')) {
            ...
            if (match) {
              ...
              if (url.startsWith('http')) {
                return (
                  <a key={j} href={url} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 underline font-semibold inline-flex items-center gap-1">
                    {text} <ArrowRight className="w-3 h-3" />
                  </a>
                );
              }
              return (
                <Link key={j} to={url} className="text-blue-600 hover:text-blue-800 underline font-semibold inline-flex items-center gap-1">
                  {text} <ArrowRight className="w-3 h-3" />
                </Link>
              );
            }
  ...
  return (
    <>
      ...
      <motion.button
        ...
        className="fixed bottom-10 right-10 z-[60] group flex items-center gap-3 bg-[#0f3460] text-white p-4 pl-6 rounded-full shadow-[0_10px_40px_rgba(15,52,96,0.3)] hover:bg-blue-900 transition-colors border border-white/10"
      >
          ...
          >
            ...
            <div className="px-6 py-4 bg-gradient-to-r from-green-50 to-emerald-50 border-t border-green-100 flex items-center justify-between flex-shrink-0">
              ...
              <a 
                ...
                className="px-5 py-2.5 bg-[#00B900] hover:bg-[#00a000] text-white text-[12px] font-bold rounded-full transition-transform hover:scale-105 shadow-sm shadow-green-200 flex items-center gap-1.5"
              >
            ...
            <div className="p-5 bg-white border-t border-gray-100 flex-shrink-0">
              <div className="flex gap-2 mb-4 overflow-x-auto pb-2 scrollbar-hide snap-x">
                {quickActions.map((action) => (
                  <button
                    ...
                    className="snap-start flex items-center gap-1.5 px-3.5 py-2.5 rounded-xl bg-blue-50/50 text-[11px] font-bold text-[#0f3460] border border-[#0f3460]/10 whitespace-nowrap hover:bg-[#0f3460] hover:text-white transition-all nav-font tracking-tight group"
                  >
              ...
              <div className="relative flex items-end gap-2">
                ...
                <button 
                  ...
                  className="absolute right-2 bottom-2 p-2.5 bg-[#0f3460] disabled:bg-gray-200 disabled:text-gray-400 text-white rounded-xl hover:bg-blue-900 transition-colors shadow-md shadow-blue-900/20 disabled:shadow-none"
                >
