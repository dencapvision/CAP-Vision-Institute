    ...
    <div className="w-full">
      <div className="flex flex-col md:flex-row items-center justify-center gap-4">
        {LEARNING_PATHS.map((path) => (
          <button
            ...
            className={`group relative flex flex-col items-start p-6 rounded-[2.5rem] border-2 transition-all w-full md:w-64 ${
              activePath === path.id
      ...
      <div className="flex justify-center gap-10 mt-12 py-6 border-y border-gray-100/50">
        {[
          ...
          <button key={item.id} className="flex items-center gap-2 text-xs font-black text-gray-400 hover:text-[#0f3460] transition-colors uppercase tracking-[0.2em] nav-font">
