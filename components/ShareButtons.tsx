...
const ShareButtons: React.FC<ShareButtonsProps> = ({ url, title }) => {
  ...
  // Use current window URL if not provided
    ...
    <div className="bg-gray-50 rounded-[3rem] p-12 text-center border border-gray-100 shadow-inner relative overflow-hidden group">
      ...
      <div className="flex justify-center gap-6 relative z-10">
        ...
        <button 
          ...
          className="w-14 h-14 bg-white rounded-2xl flex items-center justify-center text-blue-600 shadow-sm hover:shadow-md hover:scale-110 active:scale-95 transition-all group/btn border border-gray-50"
        ...
        <button 
          ...
          className={`w-14 h-14 bg-white rounded-2xl flex items-center justify-center ${copied ? 'text-green-500' : 'text-amber-500'} shadow-sm hover:shadow-md hover:scale-110 active:scale-95 transition-all group/btn border border-gray-50`}
