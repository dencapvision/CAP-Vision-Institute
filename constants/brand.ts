...
export const CLIENTS = [
    ...
    { name: 'กรมทรัพยากรน้ำบาดาล', type: 'Government', logo: 'https://assets.capvisionpartner.com/media/clients%20logo/dgr.go.th.png' },
    { name: 'ปปส.', type: 'Government', logo: 'https://assets.capvisionpartner.com/media/clients%20logo/oncb.go.th.png' },
    { name: 'สำนักงานทรัพยากรน้ำแห่งชาติ', type: 'Government', logo: 'https://assets.capvisionpartner.com/media/clients%20logo/onwr.go.th.png' },
    { name: 'สำนักงานคณะกรรมการการศึกษาขั้นพื้นฐาน', type: 'Government', logo: 'https://assets.capvisionpartner.com/media/clients%20logo/obec.go.th.png' },
    { name: 'มหาวิทยาลัยศรีนครินทรวิโรฒ', type: 'Academic', logo: 'https://assets.capvisionpartner.com/media/clients%20logo/SWU.png' },
    { name: 'มหาวิทยาลัยราชภัฏสกลนคร', type: 'Academic', logo: 'https://assets.capvisionpartner.com/media/clients%20logo/snru.ac.th.png' },
    { name: 'มหาวิทยาลัยราชภัฏยะลา', type: 'Academic', logo: 'https://assets.capvisionpartner.com/media/clients%20logo/yru.ac.th.png' },
    { name: 'เทศบาลเมืองป่าตอง จ.ภูเก็ต', type: 'Government', logo: 'https://assets.capvisionpartner.com/media/clients%20logo/patongcity.go.th.jpg' },
    { name: 'TF Cosmetology', type: 'Corporate', logo: 'https://assets.capvisionpartner.com/media/clients%20logo/TF.png' },
    { name: 'สมาคมส่งเสริมบุคลิกสตรี', type: 'Government', logo: 'https://assets.capvisionpartner.com/media/clients%20logo/thaiwomen.jpg' },
