...
export const HRD_FAQS = [
  ...
  },
  {
    ...
    answer: "ติดต่อได้ทาง LINE @denmasterfa หรือโทร 093-223-5919 ทีมงานจะรับข้อมูลและส่งใบเสนอราคาภายใน 24 ชั่วโมงครับ นอกจากนี้ยังสามารถปรึกษาครูเด่น AI บนเว็บไซต์ได้ทันที"
  }
];
