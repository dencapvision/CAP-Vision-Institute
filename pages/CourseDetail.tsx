                     ...
                     <div className="space-y-4">
                        {course.objectives?.map((obj, i) => {
                           ...
                           return (
                              <div 
                                 key={i} 
                                 className={`overflow-hidden border rounded-3xl transition-all duration-300 ${
                                    isExpanded 
                                 ...
                                 >
                                    <div className="flex items-center gap-5">
                                       <div className={`w-10 h-10 rounded-2xl flex items-center justify-center transition-colors ${
                                          isExpanded ? 'bg-[#c5a059] text-white' : 'bg-white text-[#c5a059] border border-gray-100'
                                       }`}>
                                          <CheckCircle2 className="w-5 h-5" />
                                       </div>
                                       <span className={`text-lg font-bold nav-font transition-colors ${
                                          isExpanded ? 'text-[#0f3460]' : 'text-gray-700'
                                       }`}>
                                          {obj}
                                       </span>
                                    </div>
