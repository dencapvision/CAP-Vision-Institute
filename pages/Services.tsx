...
import { SERVICES_LIST as SERVICES, TRAINING_INFO, TRANSFORMATIVE_LEARNING_INFO, FACILITATION_TRAINING_INFO, TEAM_LEADERSHIP_INFO, OD_CONSULTING_INFO } from '../constants/services';
