...
import { fetchAllArticles, type BlogArticleRow } from '../../services/blog-articles';
import { analyzeSEO, scoreColor, scoreBg, scoreLabel, type SEOResult } from '../../utils/seo-analyzer';
    ...
    <div className="space-y-6">
      ...
      {loading ? (
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-12 text-center text-gray-400">
          ...
          <Link to="/dashboard/blog/new" className="mt-3 text-sm font-black text-[#c5a059] flex items-center gap-1 justify-center hover:underline">
