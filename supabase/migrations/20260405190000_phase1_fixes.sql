...
DROP POLICY IF EXISTS "Admins full access on ai_chat_logs" ON public.ai_chat_logs;
...
DROP POLICY IF EXISTS "Admins full access on ai_sessions" ON public.ai_sessions;
