...
DROP TRIGGER IF EXISTS micro_videos_updated_at ON micro_videos;
CREATE TRIGGER micro_videos_updated_at
  BEFORE UPDATE ON micro_videos
  FOR EACH ROW EXECUTE FUNCTION set_updated_at();

DROP TRIGGER IF EXISTS toolkit_downloads_updated_at ON toolkit_downloads;
