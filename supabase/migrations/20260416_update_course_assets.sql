...
SET 
    ...
    image = 'https://nheppvjayzxlblkeanxs.supabase.co/storage/v1/object/public/media/Course/cap-vision-storytelling-for-business-course.png',
...
SET 
    ...
    image = 'https://nheppvjayzxlblkeanxs.supabase.co/storage/v1/object/public/media/Course/cap-vision-presentation-like-a-pro-course.png',
...
SET 
    ...
    image = 'https://nheppvjayzxlblkeanxs.supabase.co/storage/v1/object/public/media/Course/cap-vision-the-art-of-influential-communication-course.png',
...
SET 
    ...
    image = 'https://nheppvjayzxlblkeanxs.supabase.co/storage/v1/object/public/media/Course/cap-vision-communication-mastery-course.png',
...
SET 
    ...
    image = 'https://nheppvjayzxlblkeanxs.supabase.co/storage/v1/object/public/media/Course/cap-vision-leadership-communication-for-impact-course.png',
...
SET 
    ...
    image = 'https://nheppvjayzxlblkeanxs.supabase.co/storage/v1/object/public/media/Course/cap-vision-strategic-thinking-for-leaders-course.png',
...
SET 
    ...
    image = 'https://nheppvjayzxlblkeanxs.supabase.co/storage/v1/object/public/media/Course/cap-vision-leading-with-purpose-course.png',
...
SET 
    ...
    image = 'https://nheppvjayzxlblkeanxs.supabase.co/storage/v1/object/public/media/Course/cap-vision-transformational-leadership-course.png',
...
SET 
    ...
    image = 'https://nheppvjayzxlblkeanxs.supabase.co/storage/v1/object/public/media/Course/cap-vision-leadership-mindset-reset-course.png',
...
SET 
    ...
    image = 'https://nheppvjayzxlblkeanxs.supabase.co/storage/v1/object/public/media/Course/cap-vision-conflict-to-collaboration-course.png',
...
SET 
    ...
    image = 'https://nheppvjayzxlblkeanxs.supabase.co/storage/v1/object/public/media/Course/cap-vision-ai-mastery-for-professionals-course.png',
...
SET 
    ...
    image = 'https://nheppvjayzxlblkeanxs.supabase.co/storage/v1/object/public/media/Course/cap-vision-creative-problem-solving-course.png',
...
SET 
    ...
    image = 'https://nheppvjayzxlblkeanxs.supabase.co/storage/v1/object/public/media/Course/cap-vision-the-modern-facilitator-course.png',
